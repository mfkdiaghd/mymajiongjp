...
HTML5 + JavaScript で動作する麻雀アプリ「电脑麻将」
...
手牌表示、盤面表示、牌谱再生 など画面表示やユーザとのインタラクションを実現するクラス群です。

### tenhou-url-log
 - GitHub: https://github.com/kobalab/tenhou-url-log
 - npm: @kobalab/tenhou-url-log

电脑麻将の牌谱をネット麻雀 [天鳳](https://tenhou.net) の[JSON形式の牌谱](https://tenhou.net/6/)(各種AI解析の事実上の共通フォーマット)に変換する機能を提供します。
...
ネット麻雀 [天鳳](https://tenhou.net) の牌谱を电脑麻将形式に変換します。
本パッケージを利用することで天鳳の牌谱を解析したり、再生したりすることが可能になります。
电脑麻将 牌谱ビューアの天鳳牌谱再生は本サーバに接続して実現しています。
...
- 牌谱エディタ
  - [牌谱エディタの使い方](https://blog.kobalab.net/entry/2024/10/28/000539) (v2.4)
  - [电脑麻将でNAGA解析用のデータを作成する](https://blog.kobalab.net/entry/2024/11/02/223910) (v2.4)
- 麻雀サーバー
  ...
  - [网络对战の持ち時間設定方法](https://blog.kobalab.net/entry/2024/02/17/120315) (v2.3)
  - [麻雀ボットの実装](https://blog.kobalab.net/entry/2025/01/20/205434) (v2.4)
  - [偽ラグの実装](https://blog.kobalab.net/entry/2025/01/26/194556) (v2.4)
- 点数計算训练
  - [电脑麻将 ver.2.2.0 公開#点数計算训练](https://blog.kobalab.net/entry/2023/12/24/220847#%E7%82%B9%E6%95%B0%E8%A8%88%E7%AE%97%E3%83%89%E3%83%AA%E3%83%AB) (v2.2)
...
- プログラム構成
  - [电脑麻将のプログラム構成(0) ～ 全体編](https://blog.kobalab.net/entry/2020/07/19/212824) (v1.4)
  - [电脑麻将のプログラム構成(1) 〜 JavaScript編](https://blog.kobalab.net/entry/2020/07/24/234523) (v1.4)
  - [电脑麻将のプログラム構成(2) 〜 HTML/CSS編](https://blog.kobalab.net/entry/2020/07/29/003536) (v1.4)
- 手牌などのデータ構造
  ...
  - [电脑麻将の牌谱形式](https://blog.kobalab.net/entry/20151228/1451228689) (v0.3)
- シャンテン数計算
...
- ゲーム進行
  ...
  - [麻雀规则のカスタマイズ(0) ～ 规则一覧](https://blog.kobalab.net/entry/2021/05/01/091041) (v2.0)
  - [麻雀规则のカスタマイズ(1) ～ 終局判断とポイント計算](https://blog.kobalab.net/entry/2021/05/05/165116) (v2.0)
  - [麻雀规则のカスタマイズ(2) ～ 流局処理と連荘判断](https://blog.kobalab.net/entry/2021/05/11/070443) (v2.0)
  - [麻雀规则のカスタマイズ(3) ～ 赤牌と龙](https://blog.kobalab.net/entry/2021/12/13/213403) (v2.0)
  - [麻雀规则のカスタマイズ(4) ～ 和了役と点計算](https://blog.kobalab.net/entry/2021/12/15/064735) (v2.0)
  - [麻雀规则のカスタマイズ(5) ～ 打牌制約](https://blog.kobalab.net/entry/2021/12/17/013546) (v2.0)
- 思考ルーチン
...
- 表示処理
  - [电脑麻将におけるMVCの実装](https://blog.kobalab.net/entry/2021/03/25/205151) (v1.5)
  - [麻雀の手牌を表示するプログラム](https://blog.kobalab.net/entry/2020/08/14/234729) (v1.4)
- その他
  - [电脑麻将のプログラム中の中国語一覧](https://blog.kobalab.net/entry/20170722/1500688645) (v0.8)
  - [天鳳の牌谱形式を解析する(1)](https://blog.kobalab.net/entry/20170225/1488036549) (v0.8)
  - [天鳳の牌谱形式を解析する(2)](https://blog.kobalab.net/entry/20170228/1488294993) (v0.8)
  - [天鳳の牌谱形式を解析する(3)](https://blog.kobalab.net/entry/20170312/1489315432) (v0.8)
  - [天鳳の牌谱形式を解析する(4)](https://blog.kobalab.net/entry/20170720/1500479235) (v0.8)
  - [天鳳統計(1) 〜 基礎情報と和了役・流局理由](https://blog.kobalab.net/entry/20180113/1515776231) (v0.9)
  - [天鳳統計(2) 〜 回合ごとの向聴数・立直率・和了率](https://blog.kobalab.net/entry/20180118/1516202840) (v0.9)
  ...
  - [天鳳統計(5) 〜 回合ごとの副露数・副露時向聴数](https://blog.kobalab.net/entry/20180203/1517667551) (v0.9)
  - [切什么検討(0) 〜 打牌選択アルゴリズム](https://blog.kobalab.net/entry/2019/06/09/130640) (v1.1)
  - [切什么検討(1) ～ 好牌先打？](https://blog.kobalab.net/entry/2019/09/24/211843) (v1.3)
  - [切什么検討(2) ～ チートイとの天秤](https://blog.kobalab.net/entry/2019/10/03/120150) (v1.3)
  - [切什么検討(3) ～ 手変わりの考慮](https://blog.kobalab.net/entry/2019/10/05/122646) (v1.3)
  - [切什么検討(4) ～ 嵌八で待て！](https://blog.kobalab.net/entry/2019/10/06/082947) (v1.3)
  - [切什么検討(5) ～ 鳴きの評価](https://blog.kobalab.net/entry/2019/10/07/001354) (v1.3)
  - [切什么検討(6) ～ 良形聴牌？](https://blog.kobalab.net/entry/2019/10/08/001841) (v1.3)
  - [切什么検討(7) ～ 片アガリはダメ？](https://blog.kobalab.net/entry/2019/10/10/232937) (v1.3)
  - [牌画入力ツール](https://blog.kobalab.net/entry/20161218/1482078427) (v0.7)
  - [电脑麻将で天鳳の牌谱を検討する](https://blog.kobalab.net/entry/2020/07/08/080228) (v1.4)
